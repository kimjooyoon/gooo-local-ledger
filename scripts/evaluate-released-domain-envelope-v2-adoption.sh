...
jq -S -n \
  ...
  ([$cells[]|select(.state!="CLOSED")][0]//null) as $first |
  {
    ...
    authority:{
      projection_owner:"LOCAL_LEDGER",envelope_format_owner:"INTERCHANGE_SPECIFICATION",
